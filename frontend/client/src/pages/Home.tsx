...
// API endpoint — uses the FastAPI backend
  ...
  const handleAudit = async (formData: { url: string; businessName: string; email: string }) => {
    ...
    try {
      ...
      if (err instanceof TypeError && err.message.includes("fetch")) {
        setError("Cannot reach the audit server. Please ensure the backend is running.");
          ...
          {!auditData ? (
            <>
              ...
              <div className="text-center mb-10">
                ...
                <h1 className="syne font-extrabold text-white leading-tight mb-4"
